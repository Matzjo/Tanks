...
public class level1Controller {
    ...
    private ImageView image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image11,
            ...
            image48, image49, image50, image51, image52, image53, image54, image55, image56,  metal1, metal2, metal3, 
            metal4, metal5, metal6, metal7, metal8, metal9, metal10, metal11;
...
//     Map Generation
    ...
    private void generateMap() {
        fillEnemyTanks();
        addToBricks(image1,image2,image3,image4,image5,image6,image7,image8,image9,image10);
        addToBricks(image11,image12,image13,image14,image15,image16,image17,image18,image19,image20);
        addToBricks(image21, image22, image23, image24, image25, image26, image27, image28, image29, image30);
        addToBricks(image31, image32, image33, image34, image35, image36, image37, image38, image39, image40);
        setWater(image41, image42, image43, image44);
        setWater(image45, image46, image47, image48);
        setWater(image49, image50, image51, image52);
        setWater(image53, image54, image55, image56);
        blocks.add(metal1);
        blocks.add(metal2);
        blocks.add(metal3);
        blocks.add(metal4);
    ...
    private void addToBricks(ImageView image1,ImageView image2,ImageView image3,ImageView image4,ImageView image5,
    ...
    private void setWater(ImageView image1, ImageView image2, ImageView image3, ImageView image4) {
    	blocks.add(image1);
    	blocks.add(image2);
    	blocks.add(image3);
    	blocks.add(image4);
